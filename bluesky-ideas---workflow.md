...
- site configuration data is input via web-based form / forms.
    ...
    - The form is dynamic - prompting user to choose partials for each page, and requesting the necessary refs on choice - eg choose a banner partial for home page -> promoted for cms banners folder id.
