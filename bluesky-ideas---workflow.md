...
- site configuration data is input via web-based form / forms.
    ...
    - This web-form is dynamic - it prompts the user to choose partials for each page, and requesting the necessary refs on choice - eg choose a banner partial for home page -> promoted for cms banners folder id.
