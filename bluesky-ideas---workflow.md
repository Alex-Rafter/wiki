...
- The dev is then able to spin up locally and run checks, and add additional styling or any other parts / customisations that need to be done manually. This would be days of work rather than weeks / months as now.
