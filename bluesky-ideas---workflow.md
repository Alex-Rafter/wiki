...
- site configuration data is input via web-based form / forms.
    ...
    - This web-form is dynamic - it prompts the user eg after selecting a partial for a page, iyt prompts for the necessary dependent data such as cms node - eg choose a banner partial for home page -> promoted for cms banners folder id.
