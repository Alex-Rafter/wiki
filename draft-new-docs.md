...
- hero-bg-height-mobile (default: 'calc(100vh - 93px)'): Set the height of the hero banner on mobile devices. Same as above, but accomodates the mobile header nav e.g ```hero-bg-height="calc(100vh - 135px)"```
