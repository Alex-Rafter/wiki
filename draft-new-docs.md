...
The bsk-vehicle-card-location element is used to display the location information on the vehicle card. It includes a location icon and a location name, both of which are linked to the specified URL.
