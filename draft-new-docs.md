...
To use this with cms data, we need to get the offer-finance-details in the correct format. We have a helper function inside boilerplate's ```/inc/modules/template-logic``` directory. Add the file as an include towards the top of your page, and the you can call the function like this:
```html
