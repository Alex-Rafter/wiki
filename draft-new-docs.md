...
- hero-bg-height (default: '100vh'): The height of the hero banner on desktop - useful to adjust for the height of the header nav e.g ```hero-bg-height="calc(100vh - 135px)"```
