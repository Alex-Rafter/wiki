...
The bsk-clear-filters element is used to display a 'Clear All Filters' button that resets all select options to their default position. It is designed to be used in conjunction with COG search filters.
