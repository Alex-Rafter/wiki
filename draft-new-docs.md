...
- hero-bg-height (default: '100vh'): Set the height of the hero banner on desktop - useful to the height to accomodate the header nav e.g ```hero-bg-height="calc(100vh - 135px)"```
