...
Problem :
Adbode XD does not provide an easy way to export css rules from components. This is a problem as we need to be able to create a json file containing all of the css rules of each component / sub-component.
