...
- Bluseky Elements CLI tool + docs
  ...
  - rapid component creation from your clipboard. With this you can copy any code block and the cli tool will automatically create a new component file in the correct directory, and add the include you need to your build.
