...
- Bluseky Elements CLI tool + docs
  - 2 way sync between bluesky elements repo and build. Pull version latest of elements into a build, push edited componenst back to bluesky-elements.
  - prevent naming duplications when making new components with by listing all elements in a build.
  - rapid component creation with a single command - creates a new component from your last clipboard item,
-