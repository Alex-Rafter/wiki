...
Problem :
Adbode XD does not provide an easy way to export css rules from components without having to manually copy and paste. XD only provides an export of a small number of css rules, as css variables. We need the full set of rules assocated with the components.
