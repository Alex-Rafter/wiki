...
- Static html will be v easily shareable - either on a dev site or as static html embeds so that these can be interacted twith / and discussed prior to integration
