...
You can quickly and automatically turn any snippet into a component in 2 steps : wrapping the snippet in a template tag, and running `npm run elements 'paste'`.
