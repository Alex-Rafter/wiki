...
You can quickly turn any snippet of code wrapped in a template tag into a component by running `npm run elements 'paste'` and pasting the code into the terminal.
