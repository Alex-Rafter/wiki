...
## BP Static - Stages of UI Lib

End goal : 
- Ready to build first small site with new UI lib

Objectives: 
- BP 1.0 BSK lib brought over, refactored, in correct dir locations etc
- Add new layers of interaction / animation to BSK bring overs
- New components built out, in correct dir locations
- Examples of all in use (static) 
- Adjust styles so all cohere in terms of BP design system - consistent colours, consistent gradients where used, etc

All key pages pre-built / components for each pre-built 
- pre-built pages / layouts for key page types

Key pages templates / layouts needed: 
globally shared - headers, footers
home
used list
uvd
carnotfound
...
- Examples of use with data sources?

Prior to actually building At this point, need to do a thorough review of how data is passed to each page type
